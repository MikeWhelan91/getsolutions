        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-shrink-0">
              <div className="w-32 h-32 bg-gradient-to-br from-lime-100 to-grass-100 rounded-3xl flex items-center justify-center border-2 border-grass-300 shadow-lg overflow-hidden">
                <Image
                  src={app.icon}
                  alt={`${app.name} icon`}
                  width={128}
            ...
            <div className="flex-grow">
              <div className="mb-2">
                <span className="inline-block px-3 py-1 bg-grass-100 text-grass-700 text-sm font-semibold rounded-full border border-grass-300">
                  {app.category}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-6 mb-6 text-sm">
                {app.rating && (
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">{app.rating}</div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4">
            {app.screenshots.map((screenshot, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-48 h-[360px] bg-gradient-to-br from-gray-100 to-grass-50 rounded-xl border-2 border-gray-300 overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300"
              >
                <Image
                  src={screenshot}
      ...
      <section className="bg-white py-12 border-b-2 border-gray-200">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200 sticky top-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedApps.map((relatedApp) => (
                <Link
                  ...
                  className="group bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-grass-400 transition-all duration-300 hover:shadow-lg"
                >
                  <div className="w-16 h-16 mb-3 bg-gradient-to-br from-lime-100 to-grass-100 rounded-2xl flex items-center justify-center border border-grass-300 overflow-hidden">
                    <Image
                      src={relatedApp.icon}
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span className="font-semibold">{relatedApp.rating}</span>
                  </div>
                </Link>
              ))}
            </div>
