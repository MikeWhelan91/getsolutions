    ...
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">License and Acceptable Use</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Your Content</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">AI Features</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">LineCheck-Specific Terms</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Availability and Changes</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Disclaimers</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Limitation of Liability</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Termination</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-950 mb-4">Changes to These Terms</h2>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex gap-6 flex-wrap justify-center md:justify-end">
                ...
                <a href="/terms" className="text-neutral-400 hover:text-white transition-colors underline">
                  Terms of Service
                </a>
